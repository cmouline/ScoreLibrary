#
#  Be sure to run `pod spec lint ScoreLibrary.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Moulinet Chloë" => "cmoulinet@gmail.com" }
  # Or just: s.author    = "Moulinet Chloë"
  # s.authors            = { "Moulinet Chloë" => "cmoulinet@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Moulinet Chloë"
  ...
  s.source       = { :git => "https://github.com/cmouline/ScoreLibrary.git", :tag => "#{s.version}" }
