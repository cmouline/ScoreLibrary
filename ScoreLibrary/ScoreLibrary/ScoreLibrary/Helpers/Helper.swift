...
public class Helper {
    ...
    static func formatTimeInterval(interval: TimeInterval) -> String {
    ...
    static func formatTimeIntervalWithoutDecimal(interval: TimeInterval) -> String {
        let timeFormatter = DateComponentsFormatter()
        timeFormatter.allowedUnits = [.minute, .second]
    ...
    static func formatTimeIntervalWithoutDecimalAndTwoDigits(interval: TimeInterval) -> String {
        let timeFormatter = DateComponentsFormatter()
        timeFormatter.allowedUnits = [.minute, .second]
